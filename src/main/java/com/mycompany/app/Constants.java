...
public class Constants {
	...
	public Constants(int clientNumber, int totals, int size, boolean chopped) {
		// max table sizes
		this._DISTRICT_NUMBER = size * 1;
		this._WAREHOUSE_NUMBER = size;
		this._CUSTOMER_NUMBER = size * 1;
		this._ORDER_NUMBER = size * 1;
		this._HISTORY_NUMBER = size * 1;
		this._ITEM_NUMBER = size * 1;
		this._ORDERLINE_NUMBER = size * 1;
